...
public class EjemploExcepcionesBasico {
		...
		private static void ejemploClassNotFoundException () {
			try {
				...
				Persona persona = (Persona) Class.forName("modulo6.dateExceptions.Persona").getDeclaredConstructor().newInstance();
				...
				System.out.println("\nInvocación pierna derecha: " + Persona.class.getMethod("getPiernaDerecha").invoke(persona));
